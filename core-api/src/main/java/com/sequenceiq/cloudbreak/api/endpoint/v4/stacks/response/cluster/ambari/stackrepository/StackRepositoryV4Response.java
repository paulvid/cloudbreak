...
import com.sequenceiq.cloudbreak.api.endpoint.v4.stacks.request.cluster.ambari.stackrepository.mpack.ManagementPackV4Details;
...
public class StackRepositoryV4Response implements JsonEntity {
    ...
    private List<ManagementPackV4Details> mpacks = new ArrayList<>();
    ...
    public List<ManagementPackV4Details> getMpacks() {
        return mpacks;
    }

    public void setMpacks(List<ManagementPackV4Details> mpacks) {
        this.mpacks = mpacks;
    }
}
