...
import com.sequenceiq.cloudbreak.api.endpoint.v4.stacks.request.environment.EnvironmentV4SettingsRequest;
...
public class StackV4Request extends StackV4Base {
    ...
    private EnvironmentV4SettingsRequest environment;
    ...
    public EnvironmentV4SettingsRequest getEnvironment() {
        return environment;
    }

    public void setEnvironment(EnvironmentV4SettingsRequest environment) {
