...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.upscale.ClusterUpscaleEvent.CLUSTER_UPSCALE_START_EVENT;
...
public class ClusterUpscaleFlowConfig extends AbstractFlowConfiguration<ClusterUpscaleState, ClusterUpscaleEvent> {
    private static final List<Transition<ClusterUpscaleState, ClusterUpscaleEvent>> TRANSITIONS =
            new Builder<ClusterUpscaleState, ClusterUpscaleEvent>()
                    ...
                    // Pathway 1: repair single master
                    ...
                    .from(AMBARI_START_COMPONENTS_STATE).to(AMBARI_REPAIR_SINGLE_MASTER_FINISHED_STATE).event(AMBARI_START_COMPONENTS_FINISHED_EVENT)
                    ...
                    .from(UPSCALING_AMBARI_FINISHED_STATE).to(UPSCALING_CLUSTER_STATE).event(CLUSTER_UPSCALE_START_EVENT)
                        .noFailureEvent()
