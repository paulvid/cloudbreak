...
public class MockSuiteInitializer extends AbstractTestNGSpringContextTests {
    ...
    private boolean isImageCatalogExists(ImageCatalogV4Endpoint endpoint, String mockImageCatalogName, Long workspaceId) {
        try {
            GetImageCatalogV4Filter getImageCatalogV4Filter = new GetImageCatalogV4Filter();
            getImageCatalogV4Filter.setWithImages(false);
            return endpoint.get(workspaceId, mockImageCatalogName, getImageCatalogV4Filter) != null;
